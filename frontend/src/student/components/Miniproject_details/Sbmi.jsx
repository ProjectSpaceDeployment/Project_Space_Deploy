...
const Sbmi = () => {
  ...
  const [projectDetails, setProjectDetails] = useState({
    name: "BMI Tracker: \"Intelligent Health Monitoring System with Java & JDBC\"",
    abstract: "\"BMI Tracker\" is a Java-based system that calculates Body Mass Index (BMI) and provides health insights based on user inputs. Using JDBC connectivity, it securely stores and retrieves user data for progress tracking. The system categorizes BMI levels, offers personalized health suggestions, and ensures accurate health monitoring for better lifestyle management.",
  });
