...
const Shealth = () => {
  ...
  const [projectDetails, setProjectDetails] = useState({
    name: "HealthMeta: \"AI-Powered Personalized Health Tracker and Advisor\"",
    abstract: "\"HealthMeta\"  is an intelligent health tracking system built using Java, enabling users to input their health data while the system autonomously analyzes patterns and provides personalized wellness recommendations. By leveraging AI-driven insights, it helps users improve their health proactively.",
  });
